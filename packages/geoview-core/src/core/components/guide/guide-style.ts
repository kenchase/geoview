...
const getGuideBoxStyles = (theme: Theme): Object => ({
  ...
  '& td': {
    paddingTop: theme.spacing(0.5), // snapped from 5px
    '& img': {
  ...
  '& h1': {
    marginBottom: theme.spacing(0.5), // snapped from 5px
    marginTop: theme.spacing(2), // snapped from 15px
    paddingBottom: theme.spacing(0.5), // snapped from 5px
  ...
  '& h2': {
    marginBottom: theme.spacing(0.5), // snapped from 5px
    marginTop: theme.spacing(3), // snapped from 25px
    paddingBottom: theme.spacing(0.5), // snapped from 5px
  ...
  '& table': {
    marginBottom: theme.spacing(2), // snapped from 15px
  },
});
...
export const getSxClasses = (theme: Theme): SxStyles =>
  ({
    ...
    footerGuideListItemCollapse: {
      '& .MuiListItemText-primary': {
        padding: theme.spacing(2, 2, 2, 3.75), // snapped from '15px 15px 15px 30px'
